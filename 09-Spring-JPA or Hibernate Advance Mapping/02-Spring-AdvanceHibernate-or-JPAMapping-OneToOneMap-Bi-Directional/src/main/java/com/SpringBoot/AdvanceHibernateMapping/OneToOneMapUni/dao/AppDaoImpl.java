...
public class AppDaoImpl implements AppDao {
    ...
    @Override
    @Transactional
    public void deleteInstructorDetailById(Integer instructorDetailId) {
        InstructorDetail theInstructorDetail = entityManager.find(InstructorDetail.class, instructorDetailId);
    ...
    @Override
    @Transactional
    public void deleteInstructorDetailByIdOnly(Integer instructionDetailId) {
        InstructorDetail theInstructorDetail = entityManager.find(InstructorDetail.class, instructionDetailId);
